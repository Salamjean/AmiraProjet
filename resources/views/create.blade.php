...
<html class="no-js" lang="zxx">
    <head>
		...
		<!-- Google Fonts -->
		<link href="{{ asset('asset/https://fonts.googleapis.com/css?family=Poppins:200i,300,300i,400,400i,500,500i,600,600i,700,700i,800,800i,900,900i&display=swap') }}" rel="stylesheet">
        <!-- Bootstrap CSS -->
                    ...
                    <div class="contact-us-form">
                        ...
                        <form class="form" method="post" action="{{ route('store.reforme') }}" id="reformeForm">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <input type="text" name="ancien" placeholder="Anciennété" value="{{ old('ancien') }}" >
                                    @error('ancien')
                                    <div style="color: red;">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="dateEmbauche" placeholder="Date d'embauche" value="{{ old('dateEmbauche') }}">
                                    @error('dateEmbauche')
                                    <div style="color: red;">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label for="">Montant à proposer</label>
            ...
            $(document).ready(function() {
                ...
                @if (Session::has('error'))
                    Swal.fire({
                        ...
                        showConfirmButton: true,
                        confirmButtonText: 'OK',
                        background: '#f86750', // Rouge un peu plus foncé
